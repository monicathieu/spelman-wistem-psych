...
When we read a table of data into R, the resulting object is called a **dataframe.** Our dataframe hhas `r nrow(big5_raw)` observations, with each row coming from a different participant (I think/hope!), and `r ncol(big5_raw)` columns of data for each participant.
